            ...
            firebaseAuth.createUserWithEmailAndPassword(inputEmail,inputPw).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        Toasty.success(RegistrationActivity.this,"You've been registered successfully",Toasty.LENGTH_LONG).show();
                        ...
                        Toasty.error(RegistrationActivity.this,"Email already exists.",Toasty.LENGTH_LONG).show();
                    }
                }
            });
