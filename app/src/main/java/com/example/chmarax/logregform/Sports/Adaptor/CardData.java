package com.example.chmarax.logregform.Sports.Adaptor;
...
public class CardData implements ECCardData<com.example.chmarax.logregform.Sports.Adaptor.Comment> {
    ...
    private List<com.example.chmarax.logregform.Sports.Adaptor.Comment> listItems;
    ...
    @Override
    public List<com.example.chmarax.logregform.Sports.Adaptor.Comment> getListItems() {
        return listItems;
    }
