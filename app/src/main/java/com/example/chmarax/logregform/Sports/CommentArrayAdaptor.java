...
public class CommentArrayAdapter extends ECCardContentListItemAdapter<Comment> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        com.example.chmarax.logregform.Sports.CommentArrayAdapter.ViewHolder viewHolder;
        ...
        if (rowView == null) {
            ...
            viewHolder = new com.example.chmarax.logregform.Sports.CommentArrayAdapter.ViewHolder();
            ...
            viewHolder = (com.example.chmarax.logregform.Sports.CommentArrayAdapter.ViewHolder) rowView.getTag();
        }
