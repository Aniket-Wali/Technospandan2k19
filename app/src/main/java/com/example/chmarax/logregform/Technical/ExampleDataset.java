package com.example.chmarax.logregform.Technical;

import com.example.chmarax.logregform.R;
import com.ramotion.expandingcollection.ECCardData;
import com.example.chmarax.logregform.Technical.Adaptor.CardData;
import com.example.chmarax.logregform.Technical.Adaptor.Comment;
...
public class ExampleDataset {
    ...
    public ExampleDataset() {
        ...
        item5.setMainBackgroundResource(R.drawable.air_strike);
        item5.setHeadBackgroundResource(R.drawable.air_strike);
        ...
        item4.setMainBackgroundResource(R.drawable.night_life);
        item4.setHeadBackgroundResource(R.drawable.night_life_head);
        ...
        item3.setMainBackgroundResource(R.drawable.chemwizz);
        item3.setHeadBackgroundResource(R.drawable.chemwizz);
        ...
        item2.setMainBackgroundResource(R.drawable.fumes);
        item2.setHeadBackgroundResource(R.drawable.fumes);
        ...
        item1.setMainBackgroundResource(R.drawable.rule_the_sky_bg);
        item1.setHeadBackgroundResource(R.drawable.rule_the_sky_fg);
