package com.example.chmarax.logregform.Cultural.Adaptor;
...
public class CardData implements ECCardData<com.example.chmarax.logregform.Cultural.Adaptor.Comment> {
    ...
    private List<com.example.chmarax.logregform.Cultural.Adaptor.Comment> listItems;
    ...
    @Override
    public List<com.example.chmarax.logregform.Cultural.Adaptor.Comment> getListItems() {
        return listItems;
    }
