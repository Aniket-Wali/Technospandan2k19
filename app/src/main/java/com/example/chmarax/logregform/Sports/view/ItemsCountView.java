package com.example.chmarax.logregform.Sports.view;
...
public class ItemsCountView extends LinearLayout{
    ...
    private void init(Context context) {
        ...
        addView(textSwitcher, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
