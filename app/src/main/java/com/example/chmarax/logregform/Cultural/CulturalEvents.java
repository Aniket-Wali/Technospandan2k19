...
import com.example.chmarax.logregform.Cultural.Adaptor.CardData;
import com.example.chmarax.logregform.Cultural.CommentArrayAdapter;
import com.example.chmarax.logregform.Cultural.CulturalData;
import com.example.chmarax.logregform.Cultural.view.itemsCountView;
...
public class CulturalEvents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ECPagerViewAdapter adapter = new ECPagerViewAdapter(this, new CulturalData().getDataset()) {
            @Override
        ...
        ecPagerView = findViewById(R.id.ec_pager_element2);

        ecPagerView.setPagerViewAdapter(adapter);
        ecPagerView.setBackgroundSwitcherView((ECBackgroundSwitcherView) findViewById(R.id.ec_bg_switcher_element2));

        final itemsCountView itemsCountView = findViewById(R.id.items_count_view2);
